...
par(mfrow=c(2,2))
plot(x=train$price,y=predict(log_mod1,type="link"),pch=20)
plot(x=train$resp_rate,y=predict(log_mod1,type="link"),pch=20)
plot(x=train$guests,y=predict(log_mod1,type="link"),pch=20)
plot(x=train$bathrooms,y=predict(log_mod1,type="link"),pch=20)
plot(x=train$min_nights,y=predict(log_mod1,type="link"),pch=20)
plot(x=train$revs_month,y=predict(log_mod1,type="link"),pch=20)
plot(x=train$revs_rating,y=predict(log_mod1,type="link"),pch=20)
```
```{r}
